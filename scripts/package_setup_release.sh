...
#
# Writes: dist/The-Mummy-Recomp-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix The-Mummy-Recomp \
  --exe-name The_Mummy_Recompiled \
  --display-name "The Mummy Recompiled" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned The Mummy disc" \
