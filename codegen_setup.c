...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "the-mummy-",
    .project_root_env = "THE_MUMMY_RECOMP_PROJECT_ROOT",
    .build_dir_env = "THE_MUMMY_RECOMP_BUILD_DIR",
    .force_setup_env = "THE_MUMMY_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_011.87_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "the_mummy__Recompiled",
    .prepare_note =
